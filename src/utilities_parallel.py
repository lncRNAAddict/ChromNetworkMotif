...
import random
def get_one_random_subgraphs(G,size,chromatin_state_df,broad_states):
        ...
        random_motif_df,tmp_ = get_chromatin_state_motifs(random_subgraph_df,G_random,chromatin_state_df,size,broad_states)#.to_frame(name='count').reset_index()
...
def get_random_subgraphs_parallel(G_file,motif_size,broad_states,chromatin_state_file,num_random,n_processors=1):
# Step 1: Init multiprocessing.Pool()
  ...
  results = Parallel(n_jobs=n_processors)(delayed(get_one_random_subgraphs)(G,motif_size,chromatin_state_df,broad_states) for row in range(num_random))
  pool.close()
  #print(results)
