...
parser.add_option("-n",type="int", dest="num_random",default = 500)
...
parser.add_option("-r","--randomization",type="string", dest="rand_method",default = "I")

'''
rand_method:

I: double swap edges which means nodes and chromatin states are both randomized
II: network remains same, the chromatin states are randomized
'''
...
path = options.output_prefix + '.log.txt'
...
print("minimum frequency of motif in real network:",options.min_freq)
print("randomization method:",options.rand_method)
print("==============================================================")
...
if __name__ == '__main__':
 ...
 results = get_random_subgraphs_parallel(network_file,motif_size,broad_states,chromatin_file,num_random,num_processes,rand_method)
